...
UI = {
    ...
    "nav_compare":       {"lo": "ປຽບທຽບ ກ່ອນ–ຫຼັງ", "en": "Before vs After"},
    "compare_title":     {"lo": "ປຽບທຽບ ກ່ອນ–ຫຼັງ (ສຳຫຼວດ ↔ ຕິດຕາມເປີດບັນຊີ)", "en": "Before vs After (Survey ↔ Account Opening)"},
    "kpi_surveyed":      {"lo": "ສຳຫຼວດທັງໝົດ", "en": "Surveyed"},
    "kpi_interested":    {"lo": "ສົນໃຈ", "en": "Interested"},
    "kpi_followed":      {"lo": "ຕິດຕາມແລ້ວ", "en": "Followed up"},
    "kpi_opened":        {"lo": "ເປີດບັນຊີ", "en": "Opened"},
    "kpi_conv_followed": {"lo": "ອັດຕາແປງ (ສະເພາະທີ່ຕິດຕາມ)", "en": "Conversion (of followed-up)"},
    "kpi_conv_overall":  {"lo": "ອັດຕາແປງ (ພາບລວມ)", "en": "Conversion (overall)"},
    "compare_left":      {"lo": "ຜົນສຳຫຼວດ BOL", "en": "BOL Survey"},
    "compare_right":     {"lo": "ຕິດຕາມເປີດບັນຊີ (PSP)", "en": "PSP Follow Up"},
    "chart_interest":    {"lo": "ສັດສ່ວນຄວາມສົນໃຈ", "en": "Interest breakdown"},
    "chart_result":      {"lo": "ຜົນການຕິດຕາມ", "en": "Follow-up result"},
    "chart_by_bank":     {"lo": "ແຍກຕາມ PSP (ເປີດ vs ຍັງ)", "en": "By PSP (opened vs pending)"},
    "psp_no_data":       {"lo": "ຍັງບໍ່ມີຂໍ້ມູນ PSP Follow Up", "en": "No PSP follow-up data yet"},
...
CHOICE_EN = {
    ...
    ("biz_type", "hotel"): "Hotel & resort",
    ("biz_type", "restaurant"): "Restaurant",
    ("biz_type", "guesthouse"): "Guesthouse",
    ("biz_type", "karaoke"): "Karaoke",
    ("biz_type", "pub"): "Pub",
    ("biz_type", "nightclub"): "Nightclub",
